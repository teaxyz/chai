...
class TestSpecialCase:
    ...
    def test_special_case_crates_io(self):
        ...
        assert self.transformer.special_case("crates.io/pkgx") == "https://crates.io/crates/pkgx"
    ...
    def test_special_case_pkgx_sh(self):
        ...
        assert self.transformer.special_case("pkgx.sh/pkgx") == "https://github.com/pkgxdev/pkgx"
    ...
    def test_special_case_double_slashes(self):
        ...
        assert self.transformer.special_case("github.com/awslabs/llrt") == "github.com/awslabs/llrt"
